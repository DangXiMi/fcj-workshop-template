...
| --- | ---- | ---------- | --------------- | ------------------ |
| 1 | **Serverless Automation với AWS Lambda:** <br>&emsp; + Môi trường runtime và ngôn ngữ hỗ trợ <br>&emsp; + Cấu hình function và phân bổ bộ nhớ <br>&emsp; + Các loại trigger và event source | 22/06/2026 | 22/06/2026 | Lambda Documentation |
| 2 | **Lambda nâng cao:** <br>&emsp; + Layers và custom runtime <br>&emsp; + Quản lý biến môi trường và secret <br>&emsp; + Tích hợp VPC và networking <br>&emsp; + Giám sát với CloudWatch | 23/06/2026 | 23/06/2026 | Lambda Best Practices |
| 3 | **Serverless Backend với Lambda, S3 và DynamoDB:** <br>&emsp; + Thiết kế kiến trúc REST API serverless <br>&emsp; + Tạo Lambda function cho các thao tác CRUD <br>&emsp; + Tích hợp với API Gateway | 24/06/2026 | 24/06/2026 | Book Store Series – Phần 1 |
| 4 | **Frontend Development cho Serverless API:** <br>&emsp; + Thiết lập dự án frontend (React/JavaScript) <br>&emsp; + Kết nối frontend với API Gateway endpoint <br>&emsp; + Triển khai CRUD trên frontend | 25/06/2026 | 25/06/2026 | Book Store Series – Phần 2 |
| 5 | **Tự động hóa triển khai với AWS SAM:** <br>&emsp; + Cấu trúc và cú pháp SAM template <br>&emsp; + Định nghĩa tài nguyên (Lambda, API Gateway, DynamoDB) <br>&emsp; + Triển khai và quản lý ứng dụng | 26/06/2026 | 26/06/2026 | AWS SAM Documentation |
| 6 | **Xác thực người dùng với Amazon Cognito:** <br>&emsp; + Cấu hình Cognito User Pool <br>&emsp; + Thiết lập xác thực với Amplify <br>&emsp; + Triển khai luồng đăng ký, đăng nhập và đăng xuất | 27/06/2026 | 27/06/2026 | Cognito Workshop |
